...
INSERT INTO uaa_oauth_client (
    ...
    ('00000000-0000-0000-0000-000000001001', 'jetvam-portal',
     'Jetvam Customer Portal', true, false, 900, 2592000, false),
    ('00000000-0000-0000-0000-000000001002', 'jetvam-backoffice',
     'Jetvam Backoffice', true, false, 900, 2592000, false),
...
INSERT INTO uaa_oauth_client_grant_type (oauth_client_id, grant_type) VALUES
    ('00000000-0000-0000-0000-000000001001', 'urn:jetvam:params:oauth:grant-type:otp'),
